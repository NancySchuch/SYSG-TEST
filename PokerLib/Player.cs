...
namespace Poker.Lib
{
    ...
    public class Player : IPlayer
    {
        ...
        public void SortCards(Card[] cardsForExchange)
        {
        ...
        HandType GetHandType()
        {
            ...
            if (straight && allSameSuit)
            {
                ...
                {
                    return Poker.HandType.RoyalStraightFlush;
                }
                else
                {
                    return Poker.HandType.StraightFlush;
                }
            }
            ...
            if (sameCardSet1.Count == 4)
                return Poker.HandType.FourOfAKind;

            if (sameCardSet1.Count + sameCardSet2.Count == 5)
                return Poker.HandType.FullHouse;
            ...
            if (sameCardSet1.Count == 3)
                return Poker.HandType.ThreeOfAKind;

            if (sameCardSet1.Count + sameCardSet2.Count == 4)
                return Poker.HandType.TwoPairs;

            if (sameCardSet1.Count == 2)
                return Poker.HandType.Pair;

            return Poker.HandType.HighCard;
        }
